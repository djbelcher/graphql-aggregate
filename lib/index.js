...
import { GraphQLList, GraphQLFloat, GraphQLScalarType, GraphQLObjectType, GraphQLString, GraphQLOutputType, GraphQLFieldConfig, GraphQLInt, GraphQLInputObjectType } from 'graphql';
...
export function KeyedListAggregation(type) {
 ...
 */
var defaultFieldResolver = fieldName => obj => {
...
function createFields(type, returnType, resolver) {
    ...
    return fromJS(fields).reduce((resultFields, field, key) => {
                ...
                let fields = Map({
                    ...
                    groupedBy: {
                        type: new GraphQLObjectType({
                            ...
                            fields: () => {
                                return createFields(type, KeyedList(type), (fieldResolver, key, obj) => {
                        ...
                        fields = fields.merge(Map({
                            sum: {
                                ...
                                type: new GraphQLObjectType({
                                    ...
                                    fields: () => {
                                        return createFieldsFromFieldList(intFields, GraphQLFloat, (fieldResolver, key, obj) => {
